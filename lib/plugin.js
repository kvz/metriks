  ...
  async.waterfall([
    ...
    function (callback) {
      self.rrdtool.info(self.rrdFile, [], function(err, info) {
        ...
        // Copy plugin options
        var graphParams = {};
        _.extend(graphParams, _.omit(self.graph, 'lineColors', 'lineTitles'));
